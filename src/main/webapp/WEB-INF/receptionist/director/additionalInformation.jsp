...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
        <tr>
            <td><a class="gradient-button" href="/addHistory?id=<%=receptionist.getId()%>"><i class='bx bx-history'></i></a>
            </td>
            <td> <a class="gradient-button" href="/ControlCode?id=<%=receptionist.getId()%>"><i class='bx bxs-key'></i></a>
            </td>
        </tr>
        </tbody>
    </table>
