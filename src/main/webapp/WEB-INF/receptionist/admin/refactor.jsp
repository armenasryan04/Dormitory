    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <%if (student.getDaysUntil(student.getDeadline()).equals(0 + "d " + 0 + "h")) {%>
                <td style="color: #650404"><%= student.getDeadline() %>
                </td>
                <td style="padding: 5px; color: #5d0202"><%= student.getDaysUntil(student.getDeadline()) %>
                        <%}else {%>

                <td><%=student.getDeadline()%>
                </td>
                <td style="padding: 5px;"><%= student.getDaysUntil(student.getDeadline()) %>
                </td>
                <%}%>
